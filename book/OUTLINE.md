...
Owner: `editor`. Status: v2 (2026-09-20): 39 chapters in six parts. Chapter numbers and file names are **fixed**: writers
...
5. Part V takes the finished app to a real host, then Chapter 37 steps back and weighs every major
   decision.
6. Part VI closes the book by naming the design patterns (Chapter 38) and architectural patterns
   (Chapter 39) that the app already uses, so the reader leaves with a vocabulary for the next project.
...
### Chapter 38: Design patterns (`38-design-patterns.md`)
...
### Chapter 39: Architectural patterns (`39-architectural-patterns.md`)
...
| `book-m6-final` | 3–5, 11, 18–20, 24, 31, 36, 37, 38, 39 |
